...
//                ?: return true
//            return (setting.getData().getAs(OpenLastApp::class.java)).value
//        }
...
//            return setting.getData().getAs(ClickableClock::class.java)
//        }
//        fun setDefaultSettings(mainAppVM: MainAppVM) {
//            mainAppVM.insertSettings(defaultSettings)
//        }
...
//            mainAppVM.allCircleMenu.value?.map { it.menuImages }?.forEach { menuImages ->
...
//            context: Context
//        ) {
//            mainAppVM.allCircleMenu.value?.let { allCircleMenus ->
